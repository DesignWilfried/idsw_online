...
const Header=()=>{
    return (
        <section id="Header" className={` flex justify-center md:flex-row flex-col w-full  ${styl.paddingY}`}>
            <div className="absolute right-[50%] w-[100%] h-[400px] blue__gradient"/>
            <div className={`element bg-primary flex ${styl.flexCenter} flex-col xl:px-0 sm:px-16 py-3 px-16 relative w-full gap-5`}>
                ...
                <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
                    ...
                    <p className={`${styl.paragraph} ml-2 text-nowrap`}>
                ...
                <div className="flex flex-row justify-center items-center w-full">
                    ...
                    text-[72px] text-white ss:leading-[100px] leading-[75px] z-[3] text-center p-3">
                        <AnimatedTitle text="IDSW_online" style="text-gradient-txt "/>
                    </div>
