...
const Personal=()=>(
    <section id="Contact" className={`${styles.paddingY} ${styles.flexCenter} w-full flex-col relative`}>
        ...
        <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 relative z-[1]">
            <AnimateOnScroll style="w-full">
                <h1 className={`${styles.heading2} text-gradient`}>Que dire du personnel enseignant ?</h1>
            </AnimateOnScroll>
